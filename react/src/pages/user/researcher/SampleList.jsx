...
export default function SampleList({shared}) {
    ...
    const onDownload = () =>{
        ...
        .then((res)=>{
            setLoading(false)
            fileDownload(res.data, `${site.siteName}.xlsx`)
            // console.log(res.data)
        })
    }
        ...
        <>
            ...
            <div className="h-[50px] pl-[21%] pr-[1%] w-full flex flex-col pt-[16px]">
                ...
                <div className="w-full px-14 mt-6">
                    {loading && <Loading />}
                    <SampleTable shared={shared} samples={sample} onDelete={onDelete} />
                </div>
            </div>
                ...
                <div className="flex flex-col w-full items-center gap-4 mb-4">
                    ...
                    <div className="flex gap-1">
                        <button
                            ...
                            class="bg-transparent  text-white  py-2.5 px-4 border border-white  font-medium rounded-lg text-sm "
                        >
                        ...
                        <button
                            ...
                            class="bg-transparent  text-white  py-2.5 px-4 border border-white  font-medium rounded-lg text-xs basis-[20%]"
                        >
